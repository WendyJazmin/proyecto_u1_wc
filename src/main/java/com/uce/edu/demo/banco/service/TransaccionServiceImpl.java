...
public class TransaccionServiceImpl implements ITransaccionService{
	...
	@Autowired
	private ITransferenciaRepository iTrasnferenciaRepository;
	...
	public List<TransaccionTo> consultar(String cuenta, LocalDateTime fechaInicio, LocalDateTime fechaFin) {
		// TODO Auto-generated method stub
		List<Transferencia> listaTrans = this.iTrasnferenciaRepository.consulta(cuenta, fechaInicio, fechaFin);
		List<Deposito> listaDepo = this.iDepositoRepository.consulta(cuenta, fechaInicio, fechaFin);
		List<Retiro> listaReti = this.iRetiroRepository.consulta(cuenta, fechaInicio, fechaFin);
	...
	private TransaccionTo transformar(Retiro retiro) {
		TransaccionTo tranTo = new TransaccionTo();
		tranTo.setFecha(retiro.getFechaDeposito());
